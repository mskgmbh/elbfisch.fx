...
import org.jpac.fx.SignedIntegerOutputField;

/**
 *
 * @author berndschuster
 */
public class SignedIntegerOutputFieldTester extends ModuleTesterTemplate{
    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        Module module = new SignedIntegerOutputFieldTestModule(null,"Main");
        module.start();
        launch(args);
    }
    ...
    public void start(Stage primaryStage) {
        ...
        SignedIntegerOutputField outputField = new SignedIntegerOutputField(".analogSignal");
        outputField.setStyle("-fx-background-color: gray");
        outputField.setPrefSize(60, 60);
