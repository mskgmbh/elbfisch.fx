 ...
 */
public class SignedIntegerInputFieldTestModule extends Module{
    protected SignedInteger analogSignal;
    
    public SignedIntegerInputFieldTestModule(AbstractModule containingModule, String identifier){
