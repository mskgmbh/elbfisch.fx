...
public class CharStringOutputFieldTester extends ModuleTesterTemplate{
    ...
    public static void main(String[] args) {
        Module module = new CharStringOutputFieldTestModule(null,"Main");
        module.start();
        launch(args);
    }
    ...
    public void start(Stage primaryStage) {
        ...
        CharStringOutputField outputField = new CharStringOutputField(".charStringSignal");
        outputField.setStyle("-fx-background-color: gray");
        outputField.setPrefSize(190, 20);
