 ...
 */
public class ToggleButtonTester extends ModuleTesterTemplate{
    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        Module module = new ToggleButtonTestModule(null,"Main");
        module.start();
        launch(args);
    }
    ...
    public void start(Stage primaryStage) {
        ...
        ToggleButton toggleBtn = new ToggleButton(".buttonToggled");
