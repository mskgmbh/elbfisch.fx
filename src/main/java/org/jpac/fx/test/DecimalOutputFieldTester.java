...
import org.jpac.fx.DecimalOutputField;

/**
 *
 * @author berndschuster
 */
public class DecimalOutputFieldTester extends ModuleTesterTemplate{
    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        Module module = new DecimalOutputFieldTestModule(null,"Main");
        module.start();
        launch(args);
    }
    ...
    public void start(Stage primaryStage) {
        ...
        DecimalOutputField outputField = new DecimalOutputField(".analogSignal");
        outputField.setStyle("-fx-background-color: gray");
        outputField.setPrefSize(70, 25);
