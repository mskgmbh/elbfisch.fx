 ...
 */
public class ClickButtonTestModule extends Module{
    protected Logical buttonClicked;
    
    public ClickButtonTestModule(AbstractModule containingModule, String identifier){
        super(containingModule, identifier);
        this.buttonClicked = new Logical(this,"buttonClicked", false);
    }
    ...
    protected void work() throws ProcessException {
        try{
            Log.info("started");
            do{
                buttonClicked.becomes(true).await();
                Log.info(buttonClicked.toString());
                //do something ...
                //... and reset button request
